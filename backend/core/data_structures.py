...
class PTEntry:
    ...
    read_only: bool = False  # Read-only flag (for shared/CoW)
    shared: bool = False  # Shared frame flag
...
class Process:
    ...
    access_types: List[str] = field(default_factory=list)  # Corresponding access types ("READ"/"WRITE")
...
class SimulationStep:
    ...
    shared_frames: Dict[int, List[int]] = field(default_factory=dict)
...
class SimulationConfig:
    ...
    enable_shared_memory: bool = False  # Enable shared memory (advanced mode)
